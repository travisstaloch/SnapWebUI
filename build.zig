...
pub fn build(b: *std.Build) void {
    ...
    const exe = buildWasmExe(b, "src/snap-demo.zig", "snap-demo", optimize, mod);
    ...
    // _ = buildWasmExe(b, "src/snap-demo-builder.zig", "snap-demo-builder", optimize, mod);
...
fn buildWasmExe(b: *std.Build, path: []const u8, name: []const u8, optimize: anytype, mod: anytype) *std.Build.Step.Compile {
